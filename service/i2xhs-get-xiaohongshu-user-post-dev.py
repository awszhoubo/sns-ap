...
def lambda_handler(event, context):
    try:
        ...
        base_prefix = f"xiaohongshu/{user_id}/{post_date}/{post_id}"
        ...
        table = dynamodb.Table("i_xiaohongshu_user_post_dev")
        ...
        if item:
            ...
            filter_keyword = item.get("filter_keyword", "")
            filter_image = item.get("filter_image", "")
